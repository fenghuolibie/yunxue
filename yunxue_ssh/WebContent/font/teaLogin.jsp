...
<script>
    ...
    <header>
    	<img src="IMG/index/logo1.png" height="70">
   	    <span class="word1">欢迎教师登录</span>
   	    <span class="word1" style="display:none">注册成功，请登录</span>
   	    <a href="font/stuLogin.jsp"><h3 style="color:red">家长学生登录入口</h3></a>
    </header>
    <main>
    	<div class="tab">
    		<div class="tab_0"><img src="IMG/index/logo1.png" height="60"></div>
    		<form action="kl/teaLogin.action" method="post" >
    		    <div class="tab_1">
    		        <img src="IMG/login/account_login.png">
    		        <input id="mobile" class="login_tab" type="text" name="userPhone" placeholder="请输入您的手机号" value="${user.userPhone}">
    		    </div>
    		    <div class="tab_1">
    		        <img src="IMG/login/password_login.png">
    		        <input id="pass" class="login_tab" type="password" name="userPwd" placeholder="请输入您的密码">
    		    </div>
    		...
    		<div class="tab_2">
    			...
    			新用户,
    		    <a href="font/userRegister.jsp">去注册</a>
    		</div>
    	</div>
    </main>
    <div class="footer">
